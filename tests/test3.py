...
from curby.gather.binder import (
    artistbinder, 
    songbinder
)
...
print(billboardservice.get_popular(3))
"""
...
print(freemidiservice.get_artist_route("ariana grande"))
print(freemidiservice.get_song_route("ariana grande", "pov"))
print(freemidiservice.get_download_route("ariana grande", "pov"))
print(freemidiservice.get_cookie("ariana grande", "pov"))
"""
...
print(musicbrainzservice.get_all_songs(("ariana grande")))
print(musicbrainzservice.get_artist_genres(("ariana grande")))
print(musicbrainzservice.get_song_genres("ariana grande", "my everything"))
"""
